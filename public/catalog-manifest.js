(() => {
  const preApp = [
    ...
    ...Array.from({length:71},(_,i)=>`catalog-extensions-${i+12}.js`),
    'catalog-verified-25.js',
    ...Array.from({length:7},(_,i)=>`catalog-extensions-${i+26}.js`),
  ...
  const postApp = [
    ...
    ...Array.from({length:10},(_,i)=>`catalog-thumbnails-${i+33}-runtime.js`),
