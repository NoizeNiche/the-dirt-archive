...
Active discovery corpus now includes `builder-census-01.tsv` through `builder-census-24.tsv`.
...
The new-creator return is **still not low enough to stop**. Model-family trees are consistently exposing small historical builders and regional brands that general manufacturer directories miss. Recent high-yield seams include the DOD 250/Distortion+ lineage, vintage Schaller/Jen/OEM families, 2000s micro-builders and historical U.S. amplifier companies that also made effects.

## Next pickup point
**Stay in Queue A.** Continue targeted creator searches through Effects Database's individual OD/distortion/fuzz records, historical maker pages and related/OEM trees. Prioritize Japanese/Korean/Taiwanese historical labels, obscure 1960s-1980s European and U.S. makers, 1990s-2010s one-person boutiques, Latin America, Middle East, Africa, Southeast Asia, Soviet/Eastern Bloc, DIY-to-commercial transitions and private-label branches. The next useful move is another high-yield model-tree sweep around classic fuzz, distortion and overdrive families. Only after repeated sweeps yield mostly duplicates, aliases, known OEM families or candidate-only names should the master reconciliation across `builder-census-01.tsv` through `builder-census-24.tsv` begin. Only after reconciliation should Queue B begin creator-by-creator complete catalog enumeration.
