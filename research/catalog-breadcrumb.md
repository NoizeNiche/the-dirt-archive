...
Active discovery corpus now includes `builder-census-01.tsv` through `builder-census-25.tsv`.
...
The new-creator return is **still not low enough to stop**. The Tone Bender family tree alone exposed another deep layer of boutique and micro-builder candidates. The major discovery lesson is that model-family related pages are functioning as a second-order graph of the pedal world, not merely as lists of clones.

## Next pickup point
**Stay in Queue A.** Continue targeted creator searches through other high-yield classic-family trees, especially Fuzz Face, Big Muff, DOD 250/Distortion+, Tube Screamer, Super Fuzz/FY-6, Fuzzrite, Buzzaround, Harmonic Percolator and Rangemaster/treble-booster families. Prioritize historical maker pages and related/OEM trees, while cross-checking new candidates against the existing census before adding them. After another few high-yield sweeps begin returning mostly duplicate/known entities and candidate-only names, run the master reconciliation across `builder-census-01.tsv` through `builder-census-25.tsv`. Only after reconciliation should Queue B begin creator-by-creator complete catalog enumeration.
