...
## Phase 42 notes
Phase 42 focused on the Japanese OEM/export maze surrounding the early Super Fuzz, wedge-fuzz and later Pearl-era ecosystems. Honey Co. Ltd. is represented as a distinct historical builder with four documented products: Baby Crying, Special Fuzz, HA-9P Super Effect and Psychedelic Machine. Effects Database identifies Baby Crying as the earliest Super Fuzz lineage entry, while current Shin-Ei materials explicitly describe a reproduction of the 1967 Honey Co. Ltd. Baby Crying. citeturn126832search12turn996089search0 Independent collector documentation further describes Honey as the pre-Shin-Ei company associated with Fumio Mieda before Shin-Ei took over Honey and Companion around 1968. citeturn996089search5

Sekova is preserved as an export-brand catalog with 20 individually exposed products in the current Effects Database index, even though the page header reports 21 total; the missing indexed item remains an explicit discovery gap rather than an invented record. The lineup spans wedge fuzzes, boosters, a Big Muff, phase shifter and multi-effect treadle units. citeturn482536search0 Greco's current Effects Database snapshot contains 10 products, including the No. 35 Haztone, SD-100 Fuzz, phase units, wahs and the HA-9P Super Effect; Effects Database states that Greco effects were the same as Maxon/Ibanez effects. citeturn693476search0 The Greco Haztone is separately documented by Tone Machines Blog as part of the mysterious Japanese wedge-fuzz OEM family, with the November 1967 Japan Music Trades advertisement providing an important period breadcrumb. citeturn611630search0turn693476search3 Pearl is represented by 15 products from the documented Sound Spice and Sound Choice series, including DS-06 Distortion and OD-05 Overdrive; Effects Database's Pearl brochures explicitly identify those product families and show a 1981 Sound Spice ad. citeturn906975search0turn906975search1 Pearl-linked Vorg is kept as a discovery lead rather than a full Phase 42 builder because its five-product Effects Database snapshot is clearly linked to Pearl and needs a separate brand/OEM relationship audit. citeturn906975search10turn906975search7 Ideal is preserved as a one-product obscure export brand represented by the late-1960s Fuzz Master, with Tone Machines Blog documenting its likely shared factory lineage with the Sekova wedge fuzz. citeturn347797search0turn347797search1
