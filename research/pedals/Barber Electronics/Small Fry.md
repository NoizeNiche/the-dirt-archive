...
## PRP identity
Builder: Barber Electronics. Type: Distortion / Overdrive. Identity: Small Fry Burn Unit.

## Colorways
Red sparkle documented.

## Versions and version changes
Volume, Tone, Dynamics, Burn. Technical reviews document additional internal shaping. Small Fry and Small Fry Burn Unit are treated as one parent identity.
...
## Sound
Touch-sensitive overdrive from semi-clean punch to thicker sustaining drive. Dynamics changes feel/attack while voicing controls reshape frequency response.
