# CMC Audio — Bi Filter Fuzz

## PRP identity
- **Archive parent:** Bi Filter Fuzz
- **Builder:** CMC Audio
- **Catalog type:** Fuzz
- **Identity:** CMC Audio Bi Filter Fuzz.

## What this pedal is
The Dirt Archive's Scrape C census records this exact CMC Audio builder/model identity and classifies it as **Fuzz**. The retained project source does not preserve enough model-specific documentation to safely assign circuit lineage, full controls, component values, or revision history.
