# The Dirt Archive — Builder Master Research Census

**Purpose:** Research-stage master list of guitar dirt-pedal builders and their associated dirt products before building the public library.

**Target span:** 1960s–current

**Current research focus:** Establish builder identity and collect their dirt-pedal names. Exterior photographs and concise pedal information come later. Detailed variants, colorways, enclosure changes, components, manufacturing relationships, and deeper histories are deferred to pedal-specific deep dives.

**Governing workflow:** Builder → Pedals → Photos → Information

**Important naming rule:** Different recognized builder/product pairings remain separate. For example, Dallas-Arbiter Fuzz Face and Jim Dunlop Fuzz Face are separate builder/product entries. Within the same builder/product identity, minor alternate names or cosmetic variants can be grouped under the most recognizable name for the first pass.

## Research Status Legend

- `candidate` = discovered builder, not yet sufficiently checked
- `builder-confirmed` = builder identity supported by usable sources
- `catalog-in-progress` = builder confirmed; dirt catalog being mapped
- `cataloged` = initial dirt catalog sufficiently mapped
- `needs-review` = identity/catalog issue remains

## Initial Multi-Pedal Builder Queue

The following builders are being prioritized because current first-party pages or the existing research corpus already expose multiple dirt products.

| Builder | Priority | Initial dirt products confirmed in first-pass research | Primary source |
|---|---|---|---|
| EarthQuaker Devices | high | Hoof; Hoof Reaper; Erupter; Park Fuzz; Hizumitas; Chelsea; Special Cranker; Acapulco Gold; Plumes; Zoar; Sunn O))) Life Pedal; Sunn O))) HalfLife; Blumes; Gary; Barrows | https://www.earthquakerdevices.com/devices |
| Wren and Cuff | high | Eye See '78; Eye See '78 OG; The Good One; Box of War; Caprid; Blue-Violet Caprid; Pickle Pie B; Tall Font Russian; Super Russian; Tri-Pie '70; White Elk; Your Face 60's; Your Face 70's; Ace Octave Fuzz; Anna; Garbage Face; Garbage Face Jr.; UB-Stone; Two-Five Drive; Elephant Skin; Violet World; Fade Font '94 | https://www.wrenandcuff.com/products |
| Death By Audio | high | Fuzz War; Bass War; Apocalypse; Absolute Destruction; Supersonic Fuzz Gun; Germanium Filter | https://deathbyaudio.com/collections/fuzz |
| Basic Audio | high | Futureman; Kay Fuzz; Eve; Face; Scarab Deluxe; Bye-Bias; Texsur; Fuzz Mutant; Gnarly; Pirk; Foxton; Messenger; Orpheum; Knight; Spooky Tooth; Zippy; Foxey Lady; Blender; Wildcat; Clean Octave Blend; Fuzz Right; Solar Myth; Overtdrive; DOT; Supa; Zonk; Low Volt; Gypsy Fuzz; Super Fuzz; Tri-Ram Muff; Supa MKI; Nonts; Alter-Destiny; Shore Bird; Sharp Tooth | https://www.basicaudio.net/ |
| Fuzzrocious | high | Grey Stache; Heliotropic; 420 Fuzz v2; Grey Stache/Heliotropic; Cat King; Big Fella; Li'l Fella; Playing Mantis; Dark Driving v3; M.O.T.H.; Electric Ocean; Croak; Cat Tail; Afterlife V2; Baby Furnace | https://fuzzrociouspedals.com/?product_cat=current |
...
The official pedal archive exposes multiple dirt models including BAT, Priestess, Raw Heart OD, Skyboost, and Fnord. Source: https://www.blackartstoneworks.com/pedal/

### ZVEX Effects
The official site identifies ZVEX as a maker of guitar and bass effects since 1995. Current pages confirm Fuzz Factory, Fuzz Factory Vexter, Fuzz Factory 7 USA Vexter, and Fuzz Probe Vexter. Sources: https://www.zvex.com/guitar-pedals and individual product pages.
...
The prior archive research already produced a broad candidate roster spanning historical and modern builders. Use it as a discovery pool, not as an approved final list. Important historical candidates include Maestro, Sola Sound, Dallas-Arbiter, Rotosound, Carlsbro, WEM, John Hornby Skewes, Baldwin-Burns, Selmer, Park, Roger Mayer, Shin-Ei, Honey, Univox, Guyatone, Teisco, Ace Tone, Jen, Maxon, Ibanez, Elka, Eko, Davoli, Pearl, and Kay.

The previous fuzz census explicitly states that the roster was a working discovery roster and that many builders had not yet had their complete catalogs researched. It also identified hundreds of candidates and recommended builder-by-builder catalog verification. Source file: `dirt_archive_fuzz_builder_census_v1.md` in the project research library.

## Initial Operating Rule

Do not build the public site from this file. This is research-stage material.

For each builder, the immediate job is:

1. Establish recognizable builder identity.
2. Find the dirt pedals they produced.
3. Prefer builders with multiple dirt pedals.
4. Record the names and source links.
5. Avoid deep historical rabbit holes.
6. Do not split the same builder's product into records merely for colorways, enclosure changes, components, or cosmetic variations.
7. Do not merge separate recognized builder/product identities merely because they share a product name.
8. Do not seek internal pedal photographs.

Only after the builder census is sufficiently mature should the public catalog architecture be built.
