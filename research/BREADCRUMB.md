...
### YARP milestone: 2026-09-15 batches 06-08
Batch 06 added a structured Honey/Shin-Ei/Companion lineage pass plus JEN Elettronica and Coron catalog baselines. Batch 07 extended that work into the FY-6 export web and adjacent British/European catalog layer, adding Univox/Unicord, LRE, Tempo, Crown, Apollo, J.H. Experience, Shaftesbury/Rose-Morris, Teisco Wau Wau, WEM, Rotosound, Park, Selmer (UK), John Hornby Skewes and Firstman/Hillwood. Batch 08 then reconciled the FY-6 export-brand cluster at model level, adding evidence-qualified records for LRE, Rands, JAX, Tempo, Apollo, Crown, J.H. Experience, Shaftesbury, Teisco, Hohner, Mana, Zenta, Avora, Mayfair, Mica, Oscar and Clear Sound. Supporting files are `research/YARP-2026-09-15-batch-06.md`, `research/YARP-2026-09-15-batch-07.md`, `research/YARP-2026-09-15-batch-08.md`, `research/builder-catalog-bridge-batch-07.tsv` and `research/builder-catalog-fy6-export-08.tsv`.

### Active next move
Continue the continuous YARP run with the lesser FY-6/FY-2 export names and remaining British/European P0/P1 catalog-completion targets. Then return to JEN, Coron and the broader Japanese OEM network for completeness audits. Keep unresolved factory claims internal and evidence-qualified, update the research ledgers, and delay specimen archaeology until builder/product coverage is substantially mapped.
