...
### YARP milestone: Japanese OEM catalog layer
The latest catalog pass now has dedicated builder-level baselines for **Guyatone, Shin-Ei and Univox**. Guyatone's indexed universe includes multiple fuzz, distortion and overdrive families across FS, PS, Micro Effects and later Tube/Mighty Micro lines, including bass dirt. Shin-Ei is recorded as a high-value OEM/rebrand node, with FY-2, FY-6, WF-8 and WF-24 families linked to numerous marketed identities rather than duplicated as separate manufacturers. Univox is retained as a marketed retail identity while Unicord and Japanese manufacturing relationships remain explicit. Effects Database evidence also surfaces Mexico-circulated Suzuki-branded Shin-Ei products, reinforcing the need for regional and OEM relationship tracking.
