...
The 1997 Ibanez catalog confirms that Soundtank remained an active product family in the later 1990s, listing FZ5, SP5, PL5, TS5, CD5, CS5, PH5, CP5, DL5, BP5, BC5, CM5, TM5 and TL5 among the compact effects. The archive now treats 1989 metal construction, later plastic construction, renamed/relabelled states, and uncertain factory attribution as separate historical dimensions to be reconciled rather than flattened into one generic 'Soundtank' entry.

### YARP milestone: 2000-2005 boutique bridge expansion
A continuous-run batch has now added and cataloged a major bridge set for the transition from the 1990s boutique scene into the 2000s pedal boom: **Diamond Pedals, Xotic, Hermida Audio Technology, Pigtronix, Catalinbread, Cusack Music, MI Audio, and Menatone**.

Hard chronology anchors now include Diamond Drive development in 2003 with the first approximately 30 hand-built units shipped in June 2004; Xotic Robotalk 1 in 1998 followed by AC Booster in September 2002, RC Booster in November 2002 and BB Preamp in January 2005; Hermida's Mosferatu in 2003 and Zendrive in 2004; Pigtronix's 2004 founding and 2005 Disnortion; Catalinbread's June 2003 founding through Super Chili Picoso; and Cusack's 2002 founding with Screamer and Screamer Fuzz anchored to September 2005.

MI Audio now has a dedicated historical-baseline record covering the indexed dirt universe of Blues Pro, Crunch Box, Tube Zone, Classic Distortion, Blue Boy, G.I. Fuzz, Neo Fuzz and later Super Crunch Box. Menatone's Red Snapper and Blue Collar are established as the 1996 and 1997 first/second-pedal anchors, connecting the 1990s boutique layer to the later 2000s catalog.

The supporting files are `research/builder-catalog-2000-2005-boutique-bridge-01.tsv`, `research/builder-census-2000-2005-bridge-01.tsv`, and `research/2000-2005-boutique-bridge-audit-01.md`. These records deliberately preserve builder identity, product chronology, and later revision/reissue relationships without inferring undocumented circuit or manufacturing equivalence.
