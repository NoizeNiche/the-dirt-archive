...
- generations and V1/V2/V3/V4 boundaries
- production periods
- enclosure and finish changes
- artwork and silkscreen changes
- control-layout changes
- serial/date conventions
- packaging and labeling
- manufacturing/OEM transitions
- distributor or ownership transitions
...
Discovery batches have added Albit, Limetone Audio, Organic Sounds, RoShi Pedals, MASF Pedals, Tanabe.TV, Weed, Bananana Effects, KATANASOUND, Iannucci Audio and Kappa Electronics as dedicated builder-census targets. These remain discovery or candidate records rather than falsely complete catalogs. Primary manufacturer sources are preferred where available; specialist coverage and community reporting are retained as discovery evidence only.

### YARP milestone: early British fuzz census expansion
A historical batch added dedicated builder/census targets for G. P. Electronics, WEM, Rotosound, Baldwin-Burns/Burns London, Selmer (UK), John Hornby Skewes, Wilsic Sound, Barnes & Mullins/Exel, Park and Marshall Amplification. The associated catalog layer records early British fuzz products and their changing manufacturer/marketing relationships, including Sola Sound supply to Rotosound and Park, Sola Sound then Wilsic Sound production for Zonk II, and early Sola Sound-supplied versus later Marshall-manufactured Supa Fuzz phases. The Harmonic Generator remains a cautious antecedent record because surviving evidence is thin.

### YARP milestone: Japanese vintage OEM expansion
A further batch mapped **Ace Tone, Elk, Teisco and Walco** at builder/catalog level. Ace Tone's FM-1/FM-2/FM-3 Fuzz Master family is now represented, Elk's Big Muff Sustainar/Super Fuzz Sustainar/Wau Fuzz family is separated into model records, and Teisco's Wau Wau Fuzz is retained as a marketed/OEM relationship with reported Shin-Ei manufacture rather than being prematurely merged. Walco's rare Fuzz Tone Generator adds a low-cost portable Japanese fuzz record while factory attribution remains cautious. These records reinforce the archive's OEM rule: one physical manufacturer can sit underneath many retail names, while a marketed brand remains historically searchable without becoming a duplicate builder entity.

### YARP milestone: Nisshin Onpa / Maxon and the Japanese wedge-fuzz corridor
The Japanese manufacturer pass now has a deeper dedicated catalog for **Nisshin Onpa / Maxon**, covering the documented late-1960s fuzz-wah entry, D&S / OD-801, D&S II, OD-880, OD-808, OD-9, SD-9, MD-9, JD-01 and later Fuzz Elements family. Nisshin Onpa's own history and Susumu Tamura's account distinguish its OEM manufacturing role from the Maxon retail brand. The archive therefore links Maxon, Ibanez, Greco and other marketed names without collapsing them into a single retail identity.

The wedge-fuzz evidence remains deliberately cautious. Tone Machines Blog documents a November 1967 Japanese trade advertisement showing the Greco No.35 Fuzz Booster matching the Sekova wedge form, while Effects Database identifies strong evidence for Nisshin Onpa manufacture of the Sekova Model 59. The relationship is preserved as evidence-qualified rather than treated as universal proof for every Japanese wedge fuzz.

### YARP milestone: Coron and Japanese export/OEM web
A subsequent batch mapped the **Coron Musical Instrument Co.** dirt family, including Coron Distortion 10/15 and closely related Grant, Storm, Asama Engineering, Bias, J&J, KMD, Labo, Memphis, MX Four and Nashville labels. Effects Database explicitly identifies several of these as Coron-made OEM products and shows the family spanning the late 1970s and early 1980s. The archive keeps the physical manufacturer canonical while retaining each marketed name as a searchable relationship record.
...
### YARP milestone: Ibanez Soundtank / 5-Series catalog audit
A dedicated audit file, `research/ibanez-soundtank-catalog-audit-05.md`, now isolates the **1989-1990 metal-enclosure Soundtank run** from the later plastic 5-Series production states and reconciles the 1991-1992 catalog corridor with later 1990s catalog evidence. The strongest period anchors are the official Ibanez 1989 Soundtank catalog/dealer-sheet trail and the preserved 1991 Soundtank material. Specialist historical coverage supports treating the original metal enclosure as a distinct production-state corridor rather than lumping it together with later plastic Soundtank specimens.

The dirt layer is centered on **CR5 Crunchy Rhythm, TM5 Thrashmetal, and SF5 60's Fuzz**, with later catalog/index evidence expanding the 5-Series family around **FZ5, TS5, PL5, SP5, CM5 and other models**. The SF5/FZ5 relationship is retained as a linked retail/model-state lineage rather than two unrelated fuzz families. The archive also adds an explicit manufacturing-attribution caution: the early Ibanez/Maxon relationship should **not** be inherited automatically by Soundtank products. Aion FX states that Soundtank was not designed/manufactured by Maxon, while Effects Database reports probable Daphon association with appropriate uncertainty. Future Soundtank manufacturer fields therefore remain model-specific or unresolved until stronger documentary evidence is found.

### YARP milestone: major catalog expansion batches 03-04 and canonical relationship layer 05
Recent continuous-run work added structured catalog ledgers for Fulltone, Wampler, ZVEX Effects, EarthQuaker Devices, JHS Pedals and Sola Sound / Colorsound, followed by OEM/rebrand reconciliation. The canonical relationship index now separates physical manufacturer, marketed brand, distributor, parent company, OEM supplier, revival/reissue and same-builder production-state relationships. The archive explicitly preserves model-specific manufacturing transitions such as Sola Sound/Vox/Marshall/Rotosound/Park, JEN/Vox V828, Mosrite/Electro-Harmonix Guild Foxey Lady states, Shin-Ei/Companion/Honey/Univox, Nisshin Onpa/Maxon/Ibanez/Greco, Coron/Grant/Storm/Asama, DOD/DigiTech, BOSS/Roland and MXR/Jim Dunlop.
...
### YARP milestone: Japanese OEM network pass
The Japanese OEM/export pass confirms several important cautions for the next catalog layer. The Vox V828 should remain a distinct Italian production state rather than being merged with British Sola Sound Tone Bender production. Surviving evidence supports JEN production, while some specialist historical work also records an earlier EME attribution that remains unresolved. Honey's Super-Fuzz lineage later passed into Shin-Ei production and was distributed in the U.S. under Univox, making Honey/Shin-Ei/Univox a high-priority alias-and-lineage cluster. Shaftesbury's Duo Fuzz remains an evidence-qualified Japanese export/OEM record rather than a cleanly attributed factory entity.
...
### YARP milestone: Protocol C broad-spectrum correction
A dedicated **Protocol C** is now active in `research/PROTOCOL-C.md`. It corrects the previous tendency to spend too much research time on foundational/famous vintage pedals. The archive must now maintain a dedicated modern/broad-spectrum discovery track covering the full 1960-2026 dirt universe, with special emphasis on 1990s-2026 builders, discontinued products, regional makers, micro-builders, experimental products, limited runs, current products and obscure catalog records.

Protocol C establishes an explicit discovery ladder headed by Effects Database, then first-party manufacturer/catalog material and archived pages, followed by structured databases such as Equipboard and Reverb, specialist journalism, and collector/forum/social evidence. It also makes photography part of breadth discovery rather than a cosmetic post-processing task.

The active breadth balance is approximately **50% modern and broad-spectrum builder/product discovery, 25% catalog completion and OEM reconciliation, 15% regional/micro-builder discovery, and 10% individual pedal archaeology**. These are queue-balancing targets rather than rigid quotas, but the central anti-drift rule is mandatory: interesting vintage archaeology must not consume the breadth track while modern and obscure products remain unenumerated.

The initial modern seed queue is `research/modern-breadth-builder-seed-01.tsv`. It includes new or under-audited modern targets such as Electronic Audio Experiments, Fairfield Circuitry, Old Blood Noise Endeavors, Chase Bliss Audio, Hologram Electronics, Pladask Elektrisk, MAE/Mask Audio Electronics, Mid-Fi Electronics, Industrialectric, Dwarfcraft Devices, Black Mass Electronics, KMA Machines, Aclam, Coda Effects, Demedash, Mattoverse, Dawner Prince, Empress, Mythos, Jackson Audio, ThorpyFX, Rainger FX, Drolo, Montreal Assembly, Red Panda, T. Jauernig Electronics, and other regional/modern builders. Existing modern builders already in the master census remain eligible for quarterly/current-catalog sweeps until their complete product coverage is verified.

### Active next move
The continuous YARP run now pivots to **modern and broad-spectrum discovery first**. Build the 1990s-2026 builder/product universe outward across regions, then enumerate those builders' complete dirt catalogs, reconcile OEM/rebrand/relationship duplicates, collect product and variant photography, and only then spend concentrated time on individual historical specimens. The vintage layer remains active, but it is no longer allowed to swallow the queue.
