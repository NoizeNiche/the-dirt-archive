...
- Blocks 164-216 are stored in the active Scrape C census
- Blocks 162-163 are consolidated into `research/SCRAPE_B_CENSUS.csv`

Current Builder -> Pedals research checkpoint:
- **502 canonical builder identities are in the master index through Block 216**
...
- **214 live research blocks** are now present: Blocks 001-069, 071-141, and 143-215
...
## Next action
Continue Scrape C alphabetically after **Phaez Amplification**. Reuse canonical builder identities when a builder already exists; new builders receive the next unused ID. Keep the active Scrape C census in `research/SCRAPE_C_CENSUS.csv` until later consolidation.
