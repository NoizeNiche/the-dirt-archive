...
The next Japanese batch elevated **Nisshin Onpa / Maxon** into a dedicated builder-catalog target and mapped its dirt lineage from the late-1960s wedge-fuzz corridor through D&S, OD-880, OD-808, SD-9, the 9-Series, programmable dirt, Real Tube products and the 2013 Fuzz Elements family. The archive now treats Nisshin Onpa as a critical manufacturer/OEM node while preserving the distinction between its own Maxon retail identity and brands such as Greco, Sekova, Ibanez and Shaftesbury.

The wedge-fuzz evidence is intentionally cautious. Tone Machines Blog documents a November 1967 Japanese trade advertisement showing the Greco No.35 Fuzz Booster as the same basic wedge form as the Sekova fuzz, while Effects Database identifies strong evidence for Nisshin Onpa manufacture of the Sekova Model 59. This is a relationship record, not permission to rewrite every Japanese wedge fuzz as definitively Nisshin-made without additional primary evidence.

The same pass expanded the FY-6/Super Fuzz export layer with Honey, Rands, Shaftesbury, Zenta, Teisco and Univox relationship records. Honey's Baby Crying and Special Fuzz are retained as important early Japanese family nodes, while later FY-6 retail names remain separate searchable entities. This is exactly the kind of duplicate/OEM knot the archive is designed to preserve rather than flatten.
