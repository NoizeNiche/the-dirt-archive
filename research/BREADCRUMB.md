...
- **502 canonical builder identities are in the master index through Block 217**
...
- **215 live research blocks** are now present: Blocks 001-069, 071-141, and 143-215
...
The active Scrape C census now contains **2352 company/pedal/type rows** across 261 builder identities represented in the live working layer.
...
## Next action
Continue Scrape C alphabetically after **ThorpyFX**. Reuse canonical builder identities when a builder already exists; new builders receive the next unused ID. Keep the active Scrape C census in `research/SCRAPE_C_CENSUS.csv` until later consolidation.
