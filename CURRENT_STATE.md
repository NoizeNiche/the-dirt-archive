...
The current builder research index contains **257 canonical builder identities**, with **295 builder mentions across 157 research blocks** after the latest Scrape B continuation. The research blocks are historical working material and remain separate from the site's four-part information architecture.
...
## Next action
Continue the Scrape B company -> pedal collection alphabetically after Boo Instruments. Keep cross-referencing the canonical builder index so existing builders receive missing pedal records rather than duplicate identities.
