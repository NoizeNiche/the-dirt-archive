...
The canonical tracker currently parses to **3,819 total records / 1,274 researched records / 958 pictured and complete records / 316 researched-photo-pending records / 2,861 photo-missing records overall**. The tracker and research-record tree agree on **1,274 valid researched records**, with the remaining **316** requiring only a verified photo before PRP1 can open.
