...
## Next action
Reconcile the Block 171-173 canonical identities **329-352** into `research/BUILDER_MASTER_INDEX.md`, then continue Scrape C by checking the remaining C-section candidates and alphabetic backfills. Keep the C-section working census in `research/SCRAPE_C_CENSUS.csv` until later consolidation.
