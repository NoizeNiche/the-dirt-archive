...
The canonical tracker currently parses to **3,816 total records / 1,271 researched records / 958 pictured and complete records / 313 researched-photo-pending records / 2,858 photo-missing records overall**. Three census/status placeholders that were explicitly documented as non-product entries were removed from the pedal catalog and PRP tracker; their research notes remain archived. The tracker therefore now represents actual pedal identities only, with **313** researched pedal records requiring only a verified photo before PRP1 can open.

The most recent completed cache passes produced **0 new archived photos**. The recovery lane remains active and has since received several targeted improvements: rendered Reverb gallery capture now has a longer hydration window and a targeted scan of listing images; blocked CSS-background gallery images can now be captured as rendered elements; and curated exact-source leads were expanded across BJFE/BJF Electronics, A&M Custom Effects, AboveGroundFX, Accel Audio, Blackhawk Amplifiers, C.Q.O., CBC Pedals, and related difficult records. Unverified direct image pointers were removed rather than being allowed into the canonical catalog.
