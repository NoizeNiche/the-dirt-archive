...
Research blocks stored under `research/builders/` now run through Block 039.

Latest addition in Block 039:
...
Block 032 records BJFE / BJF Electronics — Björn Juhl dirt products using the BJFE/BearFoot archival registry and product-description archive, cross-checked with official One Control pages that explicitly identify Björn Juhl/BJF/BJFE relationships.
...
Added and re-read Builder → Pedals research Block 039.
