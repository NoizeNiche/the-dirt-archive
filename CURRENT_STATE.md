...
**Research progress:** **3,821 total / 1,259 researched** before the next photo-cache synchronization pass.

**Next exact-order research target:** **None yet. The photo-cache/deployment cycle must first synchronize this batch and recover any exact-model images it can verify.**
